...
const DoctorLayout = () => {
  ...
  return (
    <main className="min-h-screen bg-gray-100 flex flex-col">
      {/* Header */}
      <header className="bg-gradient-to-r from-green-700 to-green-600 text-white fixed top-0 left-0 w-full z-50 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold tracking-wide">Doctor Dashboard</h1>
        ...
        <aside className="w-64 bg-black shadow-lg">
          <ul className="flex flex-col p-6 gap-6 font-medium text-gray-200">
            <NavLink
              to="/doctor"
              className={({ isActive }) =>
                `cursor-pointer hover:bg-green-500 hover:text-white rounded px-4 py-3 transition duration-500 ${isActive ? "text-green-400 font-semibold" : ""}`
              }
            >
              <li>Overview</li>
            </NavLink>
